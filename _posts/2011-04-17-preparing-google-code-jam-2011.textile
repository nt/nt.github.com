...
La programmation dynaique est un outils classique du participant. Ce terme pompeux[1] cache en fait une utilisation intelligente de la mémoisation ()
...
fn2. Une technique classique: le bruteforce l'algorithme sans finesse ni rafinement mais qui fait le travail car le temps requis est raisonnable.